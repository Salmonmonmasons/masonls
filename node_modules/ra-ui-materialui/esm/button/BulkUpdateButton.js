...
var BulkUpdateButton = function (_a) {
    ...
    return mutationMode === 'undoable' ? (React.createElement(BulkUpdateWithUndoButton, __assign({}, props))) : (React.createElement(BulkUpdateWithConfirmButton, __assign({ mutationMode: mutationMode }, props)));
};
