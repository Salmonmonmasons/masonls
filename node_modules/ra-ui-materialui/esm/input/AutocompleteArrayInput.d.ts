...
export interface AutocompleteArrayInputProps extends ChoicesInputProps<TextFieldProps & Options>, Omit<SupportCreateSuggestionOptions, 'handleChange'>, Omit<DownshiftProps<any>, 'onChange'> {
}
