...
var DeleteButton = function (_a) {
    ...
    return mode === 'undoable' ? (React.createElement(DeleteWithUndoButton_1.default, __assign({ record: record }, props))) : (React.createElement(DeleteWithConfirmButton_1.default, __assign({ mutationMode: mode, record: record }, props)));
};
