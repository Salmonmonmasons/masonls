 ...
 * );
 */
var BulkUpdateButton = function (_a) {
    var mutationMode = _a.mutationMode, props = __rest(_a, ["mutationMode"]);
    return mutationMode === 'undoable' ? (React.createElement(BulkUpdateWithUndoButton_1.default, __assign({}, props))) : (React.createElement(BulkUpdateWithConfirmButton_1.default, __assign({ mutationMode: mutationMode }, props)));
};
